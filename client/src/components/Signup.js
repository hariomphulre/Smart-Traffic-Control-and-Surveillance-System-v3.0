      ...
      <Card style={{ minWidth: 350 }} className="shadow p-4">
        ...
        <Form onSubmit={handleSubmit}>
          <Form.Group className="mb-3" controlId="signupName">
            ...
            <Form.Control type="text" value={name} onChange={e => setName(e.target.value)} required autoFocus autoComplete="name" />
          </Form.Group>
          ...
          <Form.Group className="mb-3" controlId="signupPassword">
            ...
            <Form.Control type="password" value={password} onChange={e => setPassword(e.target.value)} required autoComplete="new-password" />
          </Form.Group>
